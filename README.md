...
#### Kubernetes
To deploy your application to your Kubernetes cluster, run `helm install --name myapp .` in the `/chart/KituraSabado` directory. You need to make sure you change the `repository` variable in your `chart/KituraSabado/values.yaml` file points to the docker image containing your runnable application.
